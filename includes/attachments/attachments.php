...
/**
 *  Filter activity response returned from the API. Creates and includes attachments..
 *
 * @since 1.0.0
 *
...
function appp_add_attachments_to_activity_items( $activity, $response, $request ) {
	...
	if ( isset( $files['files'] ) ) {
		...
		$response->data[0]['attachments'] = apply_filters( 'bp_rest_activity_create_item_attachments', $attachments, $activity );
	}
